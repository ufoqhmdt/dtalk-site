...
function presscore_action_add_less_vars( $less_vars ) {
	...
	if ( 'color' == of_get_option( 'header-elements-soc_icons-border' ) ) {
		$less_vars->add_rgba_color(
			...
			array( of_get_option( 'header-elements-soc_icons-border-color' ), '' ),
			of_get_option( 'header-elements-soc_icons-border-opacity' )
		);
	} else {
		$less_vars->add_hex_color(
			array('top-icons-border-color' ),
	...
	if ( 'color' == of_get_option( 'header-elements-soc_icons-hover-border' ) ) {
		$less_vars->add_rgba_color(
			...
			of_get_option( 'header-elements-soc_icons-hover-border-opacity' )
		);
	} else {
		$less_vars->add_hex_color(
			array( 'top-icons-border-color-hover' ),
	...
	// 	of_get_option( 'header-elements-soc_icons-hover-border-color' ),
	// 	of_get_option( 'header-elements-soc_icons-hover-border-opacity' )
	// );
	...
	$less_vars->add_pixel_or_percent_number(
		'soc-icon-margin-left',
		of_get_option( 'header-elements-soc_icons_margin-left', '2px' )
	);

	$less_vars->add_pixel_or_percent_number(
		'soc-icon-margin-right',
		of_get_option( 'header-elements-soc_icons_margin-right', '2px' )
	);

	$less_vars->add_pixel_or_percent_number(
		'soc-icon-margin-top',
		of_get_option( 'header-elements-soc_icons_margin-top', '2px' )
	);

	$less_vars->add_pixel_or_percent_number(
		'soc-icon-margin-bottom',
		of_get_option( 'header-elements-soc_icons_margin-bottom', '2px' )
	);
