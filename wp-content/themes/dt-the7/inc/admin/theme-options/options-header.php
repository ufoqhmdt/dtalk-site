...
$options[] = array( 'name' => _x( 'Microwidgets', 'theme-options', 'the7mk2' ), 'type' => 'heading', 'id' => 'microwidgets' );
	...
	$options[] = array(
		...
		$options[] = array( 'name' => _x( 'Icons margins', 'theme-options', 'the7mk2' ), 'type' => 'title' );
			...
			$options['header-elements-soc_icons_margin-top'] = array(
				'id' => 'header-elements-soc_icons_margin-top',
			...
			$options['header-elements-soc_icons_margin-right'] = array(
				'id' => 'header-elements-soc_icons_margin-right',
			...
			$options['header-elements-soc_icons_margin-bottom'] = array(
				'id' => 'header-elements-soc_icons_margin-bottom',
			...
			$options['header-elements-soc_icons_margin-left'] = array(
				'id' => 'header-elements-soc_icons_margin-left',
		...
		$options['header-elements-soc_icons-border'] = array(
			...
			$options['header-elements-soc_icons-border-opacity'] = array(
				'id'         => 'header-elements-soc_icons-border-opacity',
		...
		$options['header-elements-soc_icons-hover-border'] = array(
			...
			$options['header-elements-soc_icons-hover-border-opacity'] = array(
				'id'         => 'header-elements-soc_icons-hover-border-opacity',
				'name'       => _x( 'Border opacity', 'theme-options', 'the7mk2' ),
				'type'       => 'slider',
				'std'        => 100,
				'dependency' => array(
