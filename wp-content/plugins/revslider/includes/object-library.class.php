...
class RevSliderObjectLibrary {
	...
	public function __construct() {
		if (defined('REVSLIDER_THEME_ACTIVATED_URL')){
			$this->library_url = REVSLIDER_THEME_ACTIVATED_URL . 'bundled-content/';
			$this->library_list = 'revslider/library/library.php';
			$this->library_download = 'revslider/library/download.php';
		}
	}
