...
class RevSliderUpdate {
	...
	public function __construct($version) {
		if (defined('REVSLIDER_THEME_ACTIVATED_URL')){
			$theme_repo_url = REVSLIDER_THEME_ACTIVATED_URL . 'bundled-content/revslider';
			$this->remote_url		= "$theme_repo_url/check_for_updates.php";
			$this->remote_url_info	= "$theme_repo_url/revslider.php";
		}
