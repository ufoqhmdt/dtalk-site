...
if ( ! defined( 'ULTIMATE_VERSION' ) ) {
	define( 'ULTIMATE_VERSION', '3.16.13' );
}
...
if ( ! class_exists( 'Ultimate_VC_Addons' ) ) {
	...
	class Ultimate_VC_Addons {
		...
		function __construct() {
			...
			self::$uavc_editor_enable = is_admin() || ( isset( $_GET['vc_action'] ) && 'vc_inline' == $_GET['vc_action']  );
...
register_activation_hook( __FILE__, array('Ultimate_VC_Addons', 'the7_handle_brainstorm_activation' ));
add_action( 'the7_theme_activation_action', array('Convert_Plug', 'the7_handle_brainstorm_activation'), 30 );
add_action( 'after_switch_theme', array('Ultimate_VC_Addons', 'the7_handle_brainstorm_activation'), 30 );
