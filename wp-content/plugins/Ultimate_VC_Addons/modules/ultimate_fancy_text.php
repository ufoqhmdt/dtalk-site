...
if(!class_exists('Ultimate_FancyText')){
	class Ultimate_FancyText{
		...
		function register_fancytext_assets()
		{
			...
			Ultimate_VC_Addons::ultimate_register_script( 'ultimate-vticker-js', 'vticker', false, array( 'jquery' ), ULTIMATE_VERSION, false );
		}
							...
							$(document).ready(function(){
								...
								$("#vticker-'.esc_attr( $id ).'")
									.vTicker(
									{
										...
										showItems: '. esc_attr($ticker_show_items) .',
										pause: '. esc_attr($ticker_wait_time) .',
