...
if(!class_exists('AIO_Interactive_Banners'))
{
	class AIO_Interactive_Banners
	{
		...
		function banner_shortcode($atts)
		{
			...
			if($banner_title !== ''){
				$output .= "\n\t".'<h3 '.$interactive_banner_1_data_list.' class="title-'.esc_attr($banner_title_location).' bb-top-title ult-responsive" style="'.esc_attr($banner_title_style_inline).'">'.$banner_title;
